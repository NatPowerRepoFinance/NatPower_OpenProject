    ...
    params
      .expect(project: [
        ...
        { pda_nfs_attributes: [
          ...
          :created_by,
          :status_code,
          :has_project_start_date,
          :project_start_date,
          :has_grid_application_submitted,
          :grid_application_submitted,
          :has_planning_submission,
          :planning_submission,
          :has_planning_determination,
          ...
          :has_hots_date,
          :hots_date,
          :has_land_contracts_exchaged,
          :land_contracts_exchaged,
          :has_grid_offer_accepted_signed,
          :grid_offer_accepted_signed,
          :has_np_uk_envisaged_rev_date,
          :np_uk_envisaged_rev_date,
          :has_public_consultation,
          :public_consultation,
          :has_planning_condition_discharged,
          :planning_condition_discharged,
          :stage_code,
          :financial_code
        ] }
      ])
